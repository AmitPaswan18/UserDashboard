...
export const HandleEvents = () => {
  ...
  const handleDelete = () => {
    if (usernameToDelete.trim() !== "") {
      ...
      console.error("Please enter a valid username to delete.");
    }
  };
  ...
  return (
    <>
      <div
        id="mainForm"
        className="h-full p-5 w-full bg-gradient-to-r flex justify-evenly from-sky-400 to-indigo-600 ">
        ...
        <div className="w-[40%]">
          <p className="text-white">Click to see the users currently log in</p>
          <div className="flex items-center justify-center">
            <button
              className="text-xl p-1 font-semibold  rounded-md border-2"
              onClick={handleUsers}
              type="button">
              {" "}
              Users
          ...
          <div>
            {users.map((value) => {
              ...
              return (
                <div
                  className="flex flex-wrap justify-center bg-gradient-to-r from-fuchsia-600 to-pink-600 gap-1 rounded h-full w-full p-2 mt-2 text-sm"
                  key={value.id}>
